...
/*******************************************************************************************************
 ...
 SHOULD also have the following characteristics: an odd number, not the power of a prime, and have no
 factors smaller than 752. [Citation: Section 5.3.3, NIST SP 800-89].
 *******************************************************************************************************/
...
public class RsaPublicExponentTooSmall implements JavaLint {
    ...
    public LintResult execute(X509Certificate certificate) {
        ...
        if (exponent.compareTo(BigInteger.valueOf(3)) == -1) {
