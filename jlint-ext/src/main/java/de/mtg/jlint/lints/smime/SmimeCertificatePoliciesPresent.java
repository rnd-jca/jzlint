 ...
 */
@Lint(
        name = "e_smime_certificate_policies_present",
        description = "Check if a subscriber certificate has the certificatePolicies extension",
        citation = "SMIME BR 7.1.2.3a",
        source = Source.CABF_SMIME_BASELINE_REQUIREMENTS,
        effectiveDate = EffectiveDate.SMIME_BR_1_0_DATE)
public class SmimeCertificatePoliciesPresent implements JavaLint {
