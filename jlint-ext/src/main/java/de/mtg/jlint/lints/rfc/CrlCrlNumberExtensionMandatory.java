...
@Lint(
        name = "e_crl_crl_number_extension_mandatory",
        description = "Check if the CRL contains the CRL number extension",
        citation = "RFC 5280, Sec. 5",
        source = Source.RFC5280,
        effectiveDate = EffectiveDate.RFC5280)
public class CrlCrlNumberExtensionMandatory implements JavaCRLLint {
