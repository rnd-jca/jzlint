 ...
 */
@Lint(
        name = "e_ts_eku_timestamping_missing",
        description = "Check if the timestamp certificate has the id-kp-timeStamping extended key usage.",
...
public class TsEkuTimestampingMissing implements JavaLint {
