...
class SMimeEkuPresentTest {
    ...
    void passTest() throws Exception {
        ...
        caExtension.assertLintResult(LintResult.of(Status.PASS), new SMimeEkuPresent(), certificate);
    }

    @Test
    void errorTest() throws Exception {
        X509Certificate certificate = createWrongCertificate();
        caExtension.assertLintResult(LintResult.of(Status.ERROR), new SMimeEkuPresent(), certificate);
    }

    @Test
    void notEffectiveTest() throws Exception {
        X509Certificate certificate = caExtension.createNotEffectiveSmimeCertificate();
        caExtension.assertLintResult(LintResult.of(Status.NE), new SMimeEkuPresent(), certificate);
    }

    @Test
    void notApplicableTest() throws Exception {
        X509Certificate certificate = caExtension.getCaCertificate();
        caExtension.assertLintResult(LintResult.of(Status.NA), new SMimeEkuPresent(), certificate);
    }
