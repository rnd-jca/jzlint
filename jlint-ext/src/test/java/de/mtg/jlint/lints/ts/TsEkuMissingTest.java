...
class TsEkuMissingTest {
    ...
    void passTest() throws Exception {
        ...
        caExtension.assertLintResult(LintResult.of(Status.PASS), new TsEkuMissing(), certificate);
    }
    ...
    void notEffectiveTest() throws Exception {
        ...
        caExtension.assertLintResult(LintResult.of(Status.NE), new TsEkuMissing(), certificate);
    }

    @Test
    void notApplicableTest() throws Exception {
        X509Certificate certificate = caExtension.getCaCertificate();
        caExtension.assertLintResult(LintResult.of(Status.NA), new TsEkuMissing(), certificate);
    }

    private X509Certificate createWrongCertificate(int year, boolean withEKU) throws NoSuchAlgorithmException, IOException, OperatorCreationException, CertificateException, NoSuchProviderException {
