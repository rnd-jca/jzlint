...
class IssuerOrganizationNameMaxLengthTest {
    ...
    void naTest() throws Exception {
        ...
        caExtension.assertLintResult(LintResult.of(Status.NA), new IssuerOrganizationNameMaxLength(), certificate);
    }
    ...
    void passTest() throws Exception {
        ...
        caExtension.assertLintResult(LintResult.of(Status.PASS), new IssuerOrganizationNameMaxLength(), certificate);
    }

    @Test
    void errorTest() throws Exception {
        X509Certificate certificate = IssuerCommonNameMaxLengthTest.createExceedingMaximumLengthCertificate(caExtension);
        caExtension.assertLintResult(LintResult.of(Status.ERROR), new IssuerOrganizationNameMaxLength(), certificate);
    }
