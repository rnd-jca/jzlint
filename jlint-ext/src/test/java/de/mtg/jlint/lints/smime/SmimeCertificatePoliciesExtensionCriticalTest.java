...
class SmimeCertificatePoliciesExtensionCriticalTest {
    ...
    void passTest() throws Exception {
        ...
        caExtension.assertLintResult(LintResult.of(Status.PASS), new SmimeCertificatePoliciesExtensionCritical(), certificate);
    }
    ...
    void warnTest() throws Exception {
        ...
        caExtension.assertLintResult(LintResult.of(Status.WARN), new SmimeCertificatePoliciesExtensionCritical(), certificate);
    }
    ...
    private X509Certificate createTestCertificate(PublicKey caPublicKey, PrivateKey caPrivateKey, X500Name caIssuerDN, boolean critical) throws NoSuchAlgorithmException, IOException, OperatorCreationException, CertificateException, NoSuchProviderException {
        ...
        certificateBuilder.addExtension(getCertificatePolicies(critical));
    ...
    private static Extension getCertificatePolicies(boolean critical) throws IOException {
        ...
        return new Extension(Extension.certificatePolicies, critical, cps.toASN1Primitive().getEncoded(ASN1Encoding.DER));
