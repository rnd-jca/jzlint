...
class IssuerDnSerialNumberMaxLengthTest {
    ...
    void naTest() throws Exception {
        ...
        caExtension.assertLintResult(LintResult.of(Status.NA), new IssuerDnSerialNumberMaxLength(), certificate);
    }
    ...
    void passTest() throws Exception {
        ...
        caExtension.assertLintResult(LintResult.of(Status.PASS), new IssuerDnSerialNumberMaxLength(), certificate);
    }

    @Test
    void errorTest() throws Exception {
        X509Certificate certificate = IssuerCommonNameMaxLengthTest.createExceedingMaximumLengthCertificate(caExtension);
        caExtension.assertLintResult(LintResult.of(Status.ERROR), new IssuerDnSerialNumberMaxLength(), certificate);
    }
