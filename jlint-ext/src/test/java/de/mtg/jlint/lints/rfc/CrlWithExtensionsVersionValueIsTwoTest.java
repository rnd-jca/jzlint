...
class CrlWithExtensionsVersionValueIsTwoTest {
    ...
    void passTest() throws NoSuchAlgorithmException, IOException, OperatorCreationException, CRLException {
        ...
        caExtension.assertLintResult(LintResult.of(Status.PASS), true, new CrlWithExtensionsVersionValueIsTwo(), crl, null);
    }
    ...
    void errorTest() throws NoSuchAlgorithmException, IOException, NoSuchProviderException, CertificateException, SignatureException, InvalidKeyException, CRLException {
        ...
        caExtension.assertLintResult(LintResult.of(Status.ERROR), true, new CrlWithExtensionsVersionValueIsTwo(), crl, null);
    }
