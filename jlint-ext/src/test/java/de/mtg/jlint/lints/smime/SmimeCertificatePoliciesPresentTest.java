...
class SmimeCertificatePoliciesPresentTest {
    ...
    void passTest() throws Exception {
        ...
        caExtension.assertLintResult(LintResult.of(Status.PASS), new SmimeCertificatePoliciesPresent(), certificate);
    }
    ...
    void errorTest() throws Exception {
        ...
        caExtension.assertLintResult(LintResult.of(Status.ERROR), new SmimeCertificatePoliciesPresent(), certificate);
    }

    @Test
    void notApplicableTest() throws Exception {
        X509Certificate certificate = caExtension.getCaCertificate();
        caExtension.assertLintResult(LintResult.of(Status.NA), new SmimeCertificatePoliciesPresent(), certificate);
    }
    ...
    private X509Certificate createTestCertificate(PublicKey caPublicKey, PrivateKey caPrivateKey, X500Name caIssuerDN, boolean setExtension) throws NoSuchAlgorithmException, IOException, OperatorCreationException, CertificateException, NoSuchProviderException {
        ...
        if (setExtension) {
            certificateBuilder.addExtension(getCertificatePolicies());
        }
    ...
    private static Extension getCertificatePolicies() throws IOException {
