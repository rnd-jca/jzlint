...
class SmimeSKIPresentTest {
    ...
    void passTest() throws Exception {
        ...
        caExtension.assertLintResult(LintResult.of(Status.PASS), new SmimeSKIPresent(), certificate);
    }
    ...
    void warnTest() throws Exception {
        ...
        caExtension.assertLintResult(LintResult.of(Status.WARN), new SmimeSKIPresent(), certificate);
    }

    @Test
    void notApplicableTest() throws Exception {
        X509Certificate certificate = caExtension.getCaCertificate();
        caExtension.assertLintResult(LintResult.of(Status.NA), new SmimeSKIPresent(), certificate);
    }
