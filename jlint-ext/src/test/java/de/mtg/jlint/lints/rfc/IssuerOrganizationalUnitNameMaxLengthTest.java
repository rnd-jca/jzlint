...
class IssuerOrganizationalUnitNameMaxLengthTest {
    ...
    void naTest() throws Exception {
        ...
        caExtension.assertLintResult(LintResult.of(Status.NA), new IssuerOrganizationalUnitNameMaxLength(), certificate);
    }
    ...
    void passTest() throws Exception {
        ...
        caExtension.assertLintResult(LintResult.of(Status.PASS), new IssuerOrganizationalUnitNameMaxLength(), certificate);
    }

    @Test
    void errorTest() throws Exception {
        X509Certificate certificate = IssuerCommonNameMaxLengthTest.createExceedingMaximumLengthCertificate(caExtension);
        caExtension.assertLintResult(LintResult.of(Status.ERROR), new IssuerOrganizationalUnitNameMaxLength(), certificate);
    }
