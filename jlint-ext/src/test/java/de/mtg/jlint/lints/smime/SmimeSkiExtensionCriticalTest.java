...
class SmimeSkiExtensionCriticalTest {
    ...
    void passTest() throws Exception {
        ...
        caExtension.assertLintResult(LintResult.of(Status.PASS), new SmimeSkiExtensionCritical(), certificate);
    }
    ...
    void errorTest() throws Exception {
        ...
        caExtension.assertLintResult(LintResult.of(Status.ERROR), new SmimeSkiExtensionCritical(), certificate);
    }

    @Test
    void notApplicableTest() throws Exception {
        X509Certificate certificate = caExtension.getCaCertificate();
        caExtension.assertLintResult(LintResult.of(Status.NA), new SmimeSkiExtensionCritical(), certificate);
    }
    ...
    public X509Certificate createTestCertificate(PublicKey caPublicKey, PrivateKey caPrivateKey, X500Name caIssuerDN) throws NoSuchAlgorithmException, IOException, OperatorCreationException, CertificateException, NoSuchProviderException, SignatureException, InvalidKeyException {
        ...
        Extension skie = new Extension(Extension.subjectKeyIdentifier, true, ski.toASN1Primitive().getEncoded(ASN1Encoding.DER));
