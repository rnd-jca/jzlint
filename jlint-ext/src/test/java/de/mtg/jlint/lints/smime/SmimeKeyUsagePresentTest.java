...
class SmimeKeyUsagePresentTest {
    ...
    void passTest() throws Exception {
        ...
        caExtension.assertLintResult(LintResult.of(Status.PASS), new SmimeKeyUsagePresent(), certificate);
    }

    @Test
    void errorTest() throws Exception {
        X509Certificate certificate = caExtension.createSMimeEECertificate();
        caExtension.assertLintResult(LintResult.of(Status.ERROR), new SmimeKeyUsagePresent(), certificate);
    }

    @Test
    void notApplicableTest() throws Exception {
        X509Certificate certificate = caExtension.getCaCertificate();
        caExtension.assertLintResult(LintResult.of(Status.NA), new SmimeKeyUsagePresent(), certificate);
    }
