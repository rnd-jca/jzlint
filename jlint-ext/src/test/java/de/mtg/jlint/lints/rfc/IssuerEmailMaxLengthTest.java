...
class IssuerEmailMaxLengthTest {
    ...
    void naTest() throws Exception {
        ...
        caExtension.assertLintResult(LintResult.of(Status.NA), new IssuerEmailMaxLength(), certificate);
    }
    ...
    void passTest() throws Exception {
        ...
        caExtension.assertLintResult(LintResult.of(Status.PASS), new IssuerEmailMaxLength(), certificate);
    }

    @Test
    void errorTest() throws Exception {
        X509Certificate certificate = IssuerCommonNameMaxLengthTest.createExceedingMaximumLengthCertificate(caExtension);
        caExtension.assertLintResult(LintResult.of(Status.ERROR), new IssuerEmailMaxLength(), certificate);
    }
